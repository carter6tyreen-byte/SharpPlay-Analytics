...
if pitcher_df is not None and not pitcher_df.empty:
    # Apply styling specifically to the 'Value' column
    styled_pitcher = pitcher_df.style.applymap(style_pitcher_era, subset=['Value'])
...
if batter_df is not None and not batter_df.empty:
    # Apply styling specifically to the 'Value' column
    styled_batter = batter_df.style.applymap(style_batter_hr, subset=['Value'])
