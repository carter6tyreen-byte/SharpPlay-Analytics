...
class StrictLiveMLBEngine:
    ...
    def fetch_live_lineup(team_name, team_id=None):
        ...
        try:
            ...
            # Fallback to roster/boxscore active players if battingOrder list is not yet published by MLB scorer
            ...
            if not batting_order:
                # Fallback to all rostered batters if game starters aren't flagged yet
